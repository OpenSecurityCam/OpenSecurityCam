...
echo
mysql -u root -p$rootpass -e "CREATE DATABASE IF NOT EXISTS opensecuritycam; USE opensecuritycam; CREATE USER '$SQLUname'@'localhost' IDENTIFIED BY '$SQLPass'; GRANT DELETE,INSERT,SELECT ON opensecuritycam.* TO '$SQLUname'@'localhost'; FLUSH PRIVILEGES;"
